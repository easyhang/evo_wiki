...
- On 2026-07-23, resolved the local merge conflicts by retaining the current
  multi-workspace, bounded LightRAG sync, and trusted query-gateway platform
  implementation. The demo script and expanded LearnBuffett page-variant
  documentation are restored; pending changes remain uncommitted.
- On 2026-07-23, added a reproducible sanitized legal-demo bundle builder.
  ...
  `58854bd635241d7b3ce9a76ac35e731240b8f00ea591d863ee2d0045b51c581e`.
